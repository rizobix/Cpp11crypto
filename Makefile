...
BOOST_LIBRARIES=unit_test_framework
BOOST_LIBRARIES_COMMAND=$(patsubst %,-lboost_%,$(BOOST_LIBRARIES))
...
TEST_LIBRARIES = -lcwd -L$(BOOST_LIBRARY_FOLDER) $(BOOST_LIBRARIES_COMMAND) -L$(FASTFORMAT_ROOT)/lib -l$(FASTFORMAT_LIB)
